...
export default function ContactPage() {
  ...
  const radioOptionStyle: React.CSSProperties = {
    ...
    border: "1px solid rgba(201,168,76,0.2)", fontSize: "0.78rem",
    color: "#b0a090", background: "rgba(255,255,255,0.02)",
    transition: "all 0.15s", userSelect: "none"
  };

  const radioOptionActiveStyle: React.CSSProperties = {
    ...radioOptionStyle,
    border: "1px solid rgba(42,181,160,0.6)",
    background: "rgba(42,181,160,0.1)", color: "var(--teal-light)"
  };
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1.4fr", gap: "3rem", alignItems: "start" }}>
        ...
        <div>
          ...
          {[
            ...
            { icon: "📞", label: "Phone", value: "+91 74994 18833" },
        ...
        <div style={{ background: "var(--dark3)", border: "1px solid var(--border)", borderRadius: "10px", padding: "2.5rem" }}>
          {submitted ? (
            ...
            <form onSubmit={handleSubmit}>
              ...
              {/* Text fields: Name, Email, Product, Quantity */}
              {[
              ...
              <div style={{ marginBottom: "1.25rem" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {packagingSizes.map((size) => (
                    <label key={size} style={form.packagingSize === size ? radioOptionActiveStyle : radioOptionStyle}>
                ...
                {form.packagingSize === "Other" && (
                  <input
                    type="text"
                    placeholder="Please specify packaging size..."
              ...
              <div style={{ marginBottom: "1.25rem" }}>
                ...
                <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
                  {packagingTypes.map((type) => (
                    <label key={type} style={form.packagingType === type ? radioOptionActiveStyle : radioOptionStyle}>
