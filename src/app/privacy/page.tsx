    ...
    <div style={{ maxWidth: 780, margin: '0 auto', padding: '5rem 1.5rem' }}>
      ...
      <div style={{ background: 'var(--dark3)', border: '1px solid var(--border)', borderRadius: 10, padding: '2.5rem' }}>
        ...
        <Section title="5. Returns & Refund Policy">
          <Para>We accept return or refund requests within 7 days of delivery if your product arrives damaged, incorrect, or defective. Please contact us at namasteglobals@gmail.com with your order ID and photographs of the issue.</Para>
        ...
        <Section title="8. Contact">
          <Para>For any privacy or legal concerns, contact us at: <span style={{ color: 'var(--teal-light)' }}>namasteglobals@gmail.com</span> or write to Namaste Globals, R-094-09, Tanaji Lakhmoji Patil Galli, At Post Kameri, Taluka Walawa, District Sangli, Maharashtra, 415403.</Para>
        </Section>
      </div>
    </div>
  );
